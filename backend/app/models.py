...
class ImportRunHistory(Base):
    ...
    job_id: Mapped[uuid.UUID|None]=mapped_column(unique=True,index=True,nullable=True)
    trigger: Mapped[str]=mapped_column(String(20),index=True)
    source_name: Mapped[str]=mapped_column(Text,default="")
    source_path: Mapped[str|None]=mapped_column(Text,nullable=True)
    schedule_key: Mapped[str|None]=mapped_column(String(100),unique=True,nullable=True)
